...
\begin{document}
    ...
    \begin{tikzpicture}
    	...
    	\node (n5) at (1,1) {};
    \end{tikzpicture}\\\\
    Da die Graphen aus dem vorherigen Beispiel Teilgraphen von diesem Beispiel sind, gilt das auch für eine andere Anzahl der Knoten. %das stimmt glaub net so ganz...
