...
\begin{document}
    ...
    \begin{tikzpicture}
    	...
    	\node (n5) at (1,1) {};
    \end{tikzpicture}\\\\
    Da die Graphen aus vorheriger Beispiel Teilgraphen von dieses Beispiel sind, das gilt auch f"uer andere Anzahl der Kanten. Sofern kann mann sehen, dass induzierter Graph mit $V=4$ aus vollständiger Graph vieder ein 
    vollständiger Graph ist und nach Definition der Kreis, kann Kreis bilden kann. In zweiten Beispiel unabh"angige Kanten
